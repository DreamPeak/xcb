...
extern int            femas_mdapi_join(femas_mdapi_t *mdapi);
...
extern void           femas_mdspi_on_front_connected(femas_mdspi_t *mdspi,
			femas_on_front_connected func);
...
extern void           femas_mdspi_on_subscribe_topic(femas_mdspi_t *mdspi,
			femas_on_subscribe_topic func);
