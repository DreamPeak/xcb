...
extern int          ctp_mdapi_unsubscribe_market_data(ctp_mdapi_t *mdapi,
			char **instruments, int count);
extern int          ctp_mdapi_subscribe_quote_response(ctp_mdapi_t *mdapi,
			char **instruments, int count);
extern int          ctp_mdapi_unsubscribe_quote_response(ctp_mdapi_t *mdapi,
			char **instruments, int count);
...
extern void         ctp_mdspi_on_subscribe_market_data(ctp_mdspi_t *mdspi,
			ctp_on_subscribe_market_data func);
